# app_vercel.py - Vercel-compatible version (no SocketIO, uses Upstash REST API)
...
def upstash_lpush(key, value):
    """Push value to the beginning of a list in Redis"""
...
# Note: Webhook is now handled by Cloudflare Worker, 
# but we keep this for compatibility/manual testing
...
def api_webhook():
    ...
    # In Vercel version, emails are stored by the Worker
